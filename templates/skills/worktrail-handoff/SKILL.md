...
4. `worktrail handoff` writes a durable record under `.worktrail/handoffs/`; stop/session-end hooks now keep their output in runtime records instead of creating pending handoff drafts by default.
