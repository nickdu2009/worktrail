...
- Use `/worktrail-review` to inspect candidates before any promote, merge, or discard action.

Worktrail hooks may create state, checkpoints, candidates, and event logs. Hooks must never promote, merge, discard, delete, or replace knowledge.
