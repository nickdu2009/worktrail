...
var skillTriggers = []SkillTrigger{
	...
	},
	{
		...
		RootIntent:    "ending a session, compacting context, switching tools or agents, opening a new conversation, or when the user says handoff, compact, switch chat, or end current chat",
		RootCommand:   "Run `worktrail handoff \"<summary>\"`.",
		RootGuardrail: "Do not only output a copyable text handoff; write the durable record under `.worktrail/handoffs/`.",
	},
	{
